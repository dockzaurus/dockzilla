...
func (_mock *MockOption) apply(c *redis.Cache) {
	_mock.Called(c)
	return
}
...
//   - c *redis.Cache
func (_e *MockOption_Expecter) apply(c any) *MockOption_apply_Call {
	return &MockOption_apply_Call{Call: _e.mock.On("apply", c)}
}

func (_c *MockOption_apply_Call) Run(run func(c *redis.Cache)) *MockOption_apply_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *redis.Cache
		if args[0] != nil {
			arg0 = args[0].(*redis.Cache)
		}
		run(
			arg0,
		)
...
func (_c *MockOption_apply_Call) RunAndReturn(run func(c *redis.Cache)) *MockOption_apply_Call {
	_c.Run(run)
	return _c
}
