...
func (_mock *MockOption) apply(s *pg.Storage) {
	_mock.Called(s)
	return
}
...
func (_c *MockOption_apply_Call) Run(run func(s *pg.Storage)) *MockOption_apply_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *pg.Storage
		if args[0] != nil {
			arg0 = args[0].(*pg.Storage)
		}
		run(
			arg0,
		)
...
func (_c *MockOption_apply_Call) RunAndReturn(run func(s *pg.Storage)) *MockOption_apply_Call {
	_c.Run(run)
	return _c
}
