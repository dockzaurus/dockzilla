...
func (_mock *MockOption) apply(s *http.Server) {
	_mock.Called(s)
	return
}
...
func (_c *MockOption_apply_Call) Run(run func(s *http.Server)) *MockOption_apply_Call {
...
func (_c *MockOption_apply_Call) RunAndReturn(run func(s *http.Server)) *MockOption_apply_Call {
	_c.Run(run)
	return _c
}
