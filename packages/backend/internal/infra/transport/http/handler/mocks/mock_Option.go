...
func (_mock *MockOption) apply(s *handler.Sample) {
	_mock.Called(s)
	return
}
...
func (_c *MockOption_apply_Call) Run(run func(s *handler.Sample)) *MockOption_apply_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *handler.Sample
		if args[0] != nil {
			arg0 = args[0].(*handler.Sample)
		}
		run(
			arg0,
		)
...
func (_c *MockOption_apply_Call) RunAndReturn(run func(s *handler.Sample)) *MockOption_apply_Call {
	_c.Run(run)
	return _c
}
