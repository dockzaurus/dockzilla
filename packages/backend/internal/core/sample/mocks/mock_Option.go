...
func (_mock *MockOption) apply(u *sample.UseCase) {
	_mock.Called(u)
	return
}
...
//   - u *sample.UseCase
func (_e *MockOption_Expecter) apply(u any) *MockOption_apply_Call {
	return &MockOption_apply_Call{Call: _e.mock.On("apply", u)}
}

func (_c *MockOption_apply_Call) Run(run func(u *sample.UseCase)) *MockOption_apply_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *sample.UseCase
		if args[0] != nil {
			arg0 = args[0].(*sample.UseCase)
		}
		run(
			arg0,
		)
...
func (_c *MockOption_apply_Call) RunAndReturn(run func(u *sample.UseCase)) *MockOption_apply_Call {
	_c.Run(run)
	return _c
}
