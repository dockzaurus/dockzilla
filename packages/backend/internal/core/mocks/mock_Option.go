...
func (_mock *MockOption) apply(a *core.Application) {
	_mock.Called(a)
	return
}
...
//   - a *core.Application
func (_e *MockOption_Expecter) apply(a any) *MockOption_apply_Call {
	return &MockOption_apply_Call{Call: _e.mock.On("apply", a)}
}

func (_c *MockOption_apply_Call) Run(run func(a *core.Application)) *MockOption_apply_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *core.Application
		if args[0] != nil {
			arg0 = args[0].(*core.Application)
		}
		run(
			arg0,
		)
...
func (_c *MockOption_apply_Call) RunAndReturn(run func(a *core.Application)) *MockOption_apply_Call {
	_c.Run(run)
	return _c
}
